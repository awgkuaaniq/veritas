...
export default function AboutPage() {
  return (
    <main className="bg-gray-100 dark:bg-zinc-800 min-h-screen">
      ...
      {/* Mission Section */}
      <div className="flex flex-col items-center py-16 bg-white dark:bg-zinc-900">
      ...
      <div className="flex flex-col items-center py-16">
        <div className="max-w-7xl text-center mb-12">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center space-y-8 md:space-y-0 md:space-x-10 bg-white dark:bg-slate-900 rounded-lg shadow-lg p-10">
      ...
      {/* Contact Section */}
      <div className="flex flex-col items-center py-16">
        <div className="bg-white dark:bg-slate-900 shadow-lg rounded-lg p-10 max-w-4xl text-center">
          <h2 className="text-5xl font-semibold text-gray-800 dark:text-white mb-6">
            Contact Us
          </h2>
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-4">
