...
const DisclaimerPopup = ({
  ...
  return (
    <Dialog open={isOpen} onClose={() => {}} className="relative z-50">
      <DialogBackdrop
        transition
        className="fixed inset-0 bg-gray-200 dark:bg-offblack w-screen"
      />
      <div className="fixed inset-0 flex flex-col items-center justify-center">
        <DialogPanel className="fixed bg-white dark:bg-sage rounded-lg border-black/25 border">
          <div className="flex flex-col space-y-2.5 px-6 py-5 max-w-96">
            ...
            <div className="flex flex-col space-y-1 px-2.5 pb-4 border-b border-black/30">
              <DialogTitle className="font-bold text-xl">VERITAS</DialogTitle>
            ...
            <div className="flex flex-col space-y-1 p-2.5">
              ...
              <p className="text-sm text-black/80 dark:text-gray-300 text-justify">
            ...
            <div className="flex px-2.5 py-1 justify-end">
              <Button className="py-2.5 px-10" onClick={onClose}>
                Okay
              </Button>
            </div>
          </div>
