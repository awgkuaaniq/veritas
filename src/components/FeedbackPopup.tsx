...
const FeedbackPopup = ({
  ...
  useEffect(() => {
    ...
    const handleSubmit = async () => {
      ...
      setSuccessMessage("Thank you for your feedback! Your response has been submitted.");
      setRating(3);  // Reset rating
      setBody("");  // Clear feedback
    ...
    return (
      ...
      <DialogPanel className="fixed bg-white rounded border-black/25 border">
          ...
          <div className="flex flex-col py-2.5 px-16 space-y-2">
            ...
            <p className="max-w-[482px] font-light text-sm">Please feel free to share with us your experience using our website.
                Our admins will improve the website upon your feedback.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center py-3 px-16">
            ...
            />
            {error && (
              <p className="flex pt-3 text-red-500 text-sm w-fit">
                {error}
              </p>
            )}
          </div>
